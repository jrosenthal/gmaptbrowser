...
//if (thisSetting == 'userCustomSize') console.log(thisSetting,settingsObj[thisSetting],settingsSourceArray);
	...
	/*	else {
				console.log(thisSetting,settingsObj[thisSetting]);
			window.attachEvent("onload",function () {  
			window.setTimeout("applySetting('userCustomSize')",100);
			userCustomSizeDiff = [];
...
//console.log('applySetting: ', currSetting, settingsObj[currSetting]);
		switch (currSetting) {
			case 'userCustomSize':
				...
				//console.log(currSetting,settingsObj[thisSetting]);
				var xRsz = settingsObj[currSetting].split("_")[0], yRsz = settingsObj[currSetting].split("_")[1];
				self.resizeTo(xRsz,yRsz);
				break;
